...
sku2= {"Vinagrmanare6": "https://sodimac.falabella.com/sodimac-cl/product/110308912",
       "lol": "https://sodimac.falabella.com/sodimac-cl/product/110307511"} #Cambiar check
...
for sku_key, url in sku2.items():
    ...
    try:
        ...
        precio_oferta_element = driver.find_element("xpath", '//*[@id="testId-pod-prices-110308912"]/ol/li/div/span') #Cambiar
    ...
    try:
        ...
        precio_normal_element = driver.find_element("xpath", '//*[@id="testId-pod-prices-110308912"]/ol/li/div/span') #Cambiar
    ...
    if precio_oferta == "No disponible" and precio_normal == "No disponible":
        try:
            ...
            precio_normal_element = driver.find_element("xpath", '//*[@id="testId-pod-prices-110307511"]/ol/li/div/span') #Cambiar
            precio_normal = precio_normal_element.text  # Guarda el precio normal
