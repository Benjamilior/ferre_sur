...
sku2= {"Ferresurdotu258": "https://articulo.mercadolibre.cl/MLC-1741655614-electrodo-soldadura-6011-332-1kg-indura-punto-azul-_JM"} #Cambiar check
...
for sku_key, url in sku.items():
    ...
    try:
        ...
        precio_normal_element = driver.find_element("xpath", '/html/body/main/div[2]/div[3]/div[2]/div[1]/div[1]/div/div[1]/div[2]/div[2]/div[1]/div[1]/span/span/span[2]') #Cambiar
...
#         # Insertar datos
#         insert_query = """
#         INSERT INTO ferreteria_del_sur (sku, competitor, price, price_off, date) 
#         VALUES (%s, %s, %s, %s, %s)
#         """
...
#             values = (row['SKU'], competitor, row['Precio'], row['Precio_oferta'], now_str)
