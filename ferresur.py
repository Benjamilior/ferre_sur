...
for sku_key, url in sku2.items():
    ...
    try:
        ...
        precio_oferta_element = driver.find_element_by_xpath('/html/body/div[3]/main/div[2]/div[1]/div[2]/div[1]/h1/span') #Cambiar
    ...
    try:
        ...
        precio_normal_element = driver.find_element_by_xpath('/html/body/div[3]/main/div[2]/div[1]/div[2]/div[1]/h1/span') #Cambiar
